...
export default function Wedding() {
  return <main className="wedding-demo">
    <InvitationCover settings={invitationSettings({message:"Together with our families, we invite you to celebrate our wedding."})} names="Ama & Kojo" date="12 December 2026" memorial={false}/>
    <p className="sample-event-notice">Sample event · Explore the invitation, programme and guest experience.</p>
    ...
    <section className="wedding-hero"><p>TOGETHER WITH THEIR FAMILIES</p><h1 tabIndex={-1}>Ama <i>&amp;</i> Kojo</h1><div className="hero-date"><span>12</span><b>DECEMBER<br/>2026</b></div><p>ACCRA · GHANA</p><a href="#story">SCROLL TO CELEBRATE ↓</a></section>
