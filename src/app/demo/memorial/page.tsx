...
export default function Memorial() {
  return <main className="memorial-demo">
    <InvitationCover settings={invitationSettings({message:"Join family and friends to honour a cherished life and share the memories that keep us connected."})} names="Kofi Mensah" date="16–18 October 2026" memorial={true}/>
